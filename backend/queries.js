...
async function setupDevDatabase(request, response) {
  ...
  const populateUserTable = `
    INSERT INTO "slacker_users" (name, email, password)
      VALUES ('Dio', 'dio@example.com', 'awesome'), ('Susan', 'susan@example.com', 'cool'), ('Simon', 'simon@example.com', 'epic'), ('Jerry', 'jerry@example.com', 'fantabulous'), ('Wendy', 'wendy@example.com', 'mindblowing'
    );`;
